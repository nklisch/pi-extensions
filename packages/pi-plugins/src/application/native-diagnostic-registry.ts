...
export const NativeDiagnosticRegistry = Object.freeze({
  stateCorrupt: { code: "STATE_CORRUPT", category: "integrity", severity: "error", rank: 100, blocks: true, unavailable: false, action: "repair", summary: "Authoritative plugin state is corrupt." },
  recordCorrupt: { code: "RECORD_CORRUPT", category: "integrity", severity: "error", rank: 110, blocks: true, unavailable: false, action: "repair", summary: "An authoritative plugin record is corrupt." },
  pluginDegraded: { code: "PLUGIN_DEGRADED", category: "activation", severity: "error", rank: 200, blocks: true, unavailable: false, action: "repair", summary: "The selected plugin revision is degraded." },
  pluginFallbackActive: { code: "PLUGIN_FALLBACK_ACTIVE", category: "activation", severity: "warning", rank: 205, blocks: true, unavailable: false, action: "rollback", summary: "The plugin is running its previous revision." },
  convergenceDeferred: { code: "CONVERGENCE_DEFERRED", category: "activation", severity: "warning", rank: 220, blocks: false, unavailable: false, action: "repair", summary: "Startup convergence retained work for a later pass." },
  convergenceBlocked: { code: "CONVERGENCE_BLOCKED", category: "activation", severity: "error", rank: 230, blocks: true, unavailable: false, action: "repair", summary: "Startup convergence could not complete." },
  startupBlocked: { code: "HOST_STARTUP_BLOCKED", category: "activation", severity: "error", rank: 240, blocks: true, unavailable: false, action: "reload-runtime", summary: "Packaged host startup did not establish a usable runtime." },
  ...
  mcpRuntimeUnavailable: { code: "MCP_RUNTIME_UNAVAILABLE", category: "capability", severity: "error", rank: 415, blocks: true, unavailable: false, action: "reload-runtime", summary: "The MCP runtime is unavailable for an enabled MCP plugin." },
  ...
  revisionUnavailable: { code: "REVISION_UNAVAILABLE", category: "activation", severity: "error", rank: 590, blocks: true, unavailable: false, action: "repair", summary: "The selected immutable revision is unavailable." },
  ...
  updateAutomaticPending: { code: "UPDATE_AUTOMATIC_PENDING", category: "update", severity: "info", rank: 821, blocks: false, unavailable: false, action: "review-update", summary: "An automatic update is waiting for the next update cycle." },
  ...
  updateDegraded: { code: "UPDATE_DEGRADED", category: "update", severity: "error", rank: 830, blocks: true, unavailable: false, action: "repair", summary: "An installed update is degraded." },
