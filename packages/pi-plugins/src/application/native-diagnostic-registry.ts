...
export const NativeDiagnosticRegistry = Object.freeze({
  ...
  updateStaged: { code: "UPDATE_STAGED", category: "update", severity: "info", rank: 215, blocks: false, unavailable: false, action: "review-update", summary: "Update installed — live on next start." },
